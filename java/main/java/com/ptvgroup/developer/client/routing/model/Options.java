...
@JsonPropertyOrder({
  ...
  Options.JSON_PROPERTY_MAXIMUM_DISTANCE_BETWEEN_EVENTS
})
...
public class Options {
  ...
  public static final String JSON_PROPERTY_MAXIMUM_DISTANCE_BETWEEN_EVENTS = "maximumDistanceBetweenEvents";
  private Integer maximumDistanceBetweenEvents;
  ...
  public Options maximumDistanceBetweenEvents(Integer maximumDistanceBetweenEvents) {
   ...
   * minimum: 500
   * @return maximumDistanceBetweenEvents
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_MAXIMUM_DISTANCE_BETWEEN_EVENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Integer getMaximumDistanceBetweenEvents() {
    return maximumDistanceBetweenEvents;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MAXIMUM_DISTANCE_BETWEEN_EVENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaximumDistanceBetweenEvents(Integer maximumDistanceBetweenEvents) {
    this.maximumDistanceBetweenEvents = maximumDistanceBetweenEvents;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.startTime, options.startTime) &&
        ...
        Objects.equals(this.maximumDistanceBetweenEvents, options.maximumDistanceBetweenEvents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(startTime, arrivalTime, tollTime, trafficMode, allowedCountries, prohibitedCountries, preferTurnsOnPassengerSide, avoid, blockIntersectingRoads, customRoadAttributeScenarios, routingMode, maximumSpeed, speedFactor, language, polylineFormat, polylineMapType, currency, maximumDistanceBetweenEvents);
  }
  ...
  public String toString() {
    ...
    sb.append("    maximumDistanceBetweenEvents: ").append(toIndentedString(maximumDistanceBetweenEvents)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `maximumDistanceBetweenEvents` to the URL query string
    if (getMaximumDistanceBetweenEvents() != null) {
      joiner.add(String.format("%smaximumDistanceBetweenEvents%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getMaximumDistanceBetweenEvents()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
