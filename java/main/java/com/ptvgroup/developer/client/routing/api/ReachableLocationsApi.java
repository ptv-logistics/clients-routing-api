...
public class ReachableLocationsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ReachableLocationsResponse getReachableLocations(UUID id, Integer maximumPollingPeriod) throws ApiException {
    ApiResponse<ReachableLocationsResponse> localVarResponse = getReachableLocationsWithHttpInfo(id, maximumPollingPeriod);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ReachableLocationsResponse> getReachableLocationsWithHttpInfo(UUID id, Integer maximumPollingPeriod) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getReachableLocationsRequestBuilder(id, maximumPollingPeriod);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getReachableLocationsRequestBuilder(UUID id, Integer maximumPollingPeriod) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
   ...
   * @param horizon The distance [m] or travel time [s] of the horizons, depending of the **horizonType** (limited to 200 km or 2 hours from a waypoint, 50 km or 45 minutes from a route). (required)
