...
import com.ptvgroup.developer.client.routing.model.ElevationReport;
...
@JsonPropertyOrder({
  ...
  RouteResponse.JSON_PROPERTY_ELEVATION_REPORT,
...
public class RouteResponse {
  ...
  public static final String JSON_PROPERTY_ELEVATION_REPORT = "elevationReport";
  private ElevationReport elevationReport;
  ...
  public RouteResponse elevationReport(ElevationReport elevationReport) {
    this.elevationReport = elevationReport;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ELEVATION_REPORT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public ElevationReport getElevationReport() {
    return elevationReport;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ELEVATION_REPORT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setElevationReport(ElevationReport elevationReport) {
    this.elevationReport = elevationReport;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.distance, routeResponse.distance) &&
        ...
        Objects.equals(this.elevationReport, routeResponse.elevationReport) &&
        Objects.equals(this.warnings, routeResponse.warnings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(distance, travelTime, trafficDelay, violated, routeId, legs, toll, polyline, events, emissions, alternativeRoutes, scheduleReport, evReport, guidedNavigation, monetaryCosts, elevationReport, warnings);
  }
  ...
  public String toString() {
    ...
    sb.append("    elevationReport: ").append(toIndentedString(elevationReport)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `elevationReport` to the URL query string
    if (getElevationReport() != null) {
      joiner.add(getElevationReport().toUrlQueryString(prefix + "elevationReport" + suffix));
    }
