...
import com.ptvgroup.developer.client.routing.model.RouteOptions;
...
@JsonPropertyOrder({
  ...
  RouteRequest.JSON_PROPERTY_ROUTE_OPTIONS
})
...
public class RouteRequest {
  ...
  public static final String JSON_PROPERTY_ROUTE_OPTIONS = "routeOptions";
  ...
  public RouteRequest routeOptions(RouteOptions routeOptions) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ROUTE_OPTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.waypoints, routeRequest.waypoints) &&
        ...
        Objects.equals(this.routeOptions, routeRequest.routeOptions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(waypoints, routeId, driver, routeOptions);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `routeOptions` to the URL query string
    if (getRouteOptions() != null) {
      joiner.add(getRouteOptions().toUrlQueryString(prefix + "routeOptions" + suffix));
    }
