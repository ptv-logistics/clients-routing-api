...
import {
    RouteOptionsFromJSON,
    RouteOptionsFromJSONTyped,
    RouteOptionsToJSON,
} from './RouteOptions';
...
export function RouteRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteRequest {
    ...
    return {
        ...
        'routeOptions': json['routeOptions'] == null ? undefined : RouteOptionsFromJSON(json['routeOptions']),
    };
}
...
export function RouteRequestToJSON(value?: RouteRequest | null): any {
    ...
    return {
        ...
        'routeOptions': RouteOptionsToJSON(value['routeOptions']),
    };
}
