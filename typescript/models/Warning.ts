...
export interface Warning {
     ...
     * * `ROUTING_TOLL_EXCHANGE_RATE_UNAVAILABLE` - The exchange rate for at least one toll currency is not available. Toll prices in affected currencies are not converted.
     *   * `currencies` - The currencies for which no exchange rate is available (array of strings).
     * 
     * @type {string}
     * @memberof Warning
     */
