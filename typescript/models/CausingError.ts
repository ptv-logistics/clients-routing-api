...
export interface CausingError {
     ...
     *   * `value` - The invalid parameter value.
     * * `ROUTING_OPENING_INTERVALS_REQUIRE_TIME` - When using waypoints with opening intervals or a **routeId** containing such waypoints, a start time has to be specified when **options[trafficMode]** is not _REALISTIC_.
