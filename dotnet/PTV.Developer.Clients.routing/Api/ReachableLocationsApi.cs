...
namespace PTV.Developer.Clients.routing.Api
{
    ...
    public interface IReachableLocationsApiSync : IApiAccessor
    {
        ...
        ReachableLocationsResponse GetReachableLocations(Guid? id, int? maximumPollingPeriod = default(int?), int operationIndex = 0);
        ...
        ApiResponse<ReachableLocationsResponse> GetReachableLocationsWithHttpInfo(Guid? id, int? maximumPollingPeriod = default(int?), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="PTV.Developer.Clients.routing.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="horizon">The distance [m] or travel time [s] of the horizons, depending of the **horizonType** (limited to 200 km or 2 hours from a waypoint, 50 km or 45 minutes from a route).</param>
        ...
        /// <param name="routeId">Instead of the waypoint mentioned above, a **routeId** from a previously calculated route or a matched track can be entered. More information and applying restrictions can be found [here](./concepts/route-ids). (optional)</param>
    ...
    public interface IReachableLocationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ReachableLocationsResponse> GetReachableLocationsAsync(Guid? id, int? maximumPollingPeriod = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ReachableLocationsResponse>> GetReachableLocationsWithHttpInfoAsync(Guid? id, int? maximumPollingPeriod = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class ReachableLocationsApi : IReachableLocationsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ReachableLocationsResponse</returns>
        public ReachableLocationsResponse GetReachableLocations(Guid? id, int? maximumPollingPeriod = default(int?), int operationIndex = 0)
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<ReachableLocationsResponse> localVarResponse = GetReachableLocationsWithHttpInfo(id, maximumPollingPeriod);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ReachableLocationsResponse</returns>
        public PTV.Developer.Clients.routing.Client.ApiResponse<ReachableLocationsResponse> GetReachableLocationsWithHttpInfo(Guid? id, int? maximumPollingPeriod = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(PTV.Developer.Clients.routing.Client.ClientUtils.ParameterToMultiMap("", "maximumPollingPeriod", maximumPollingPeriod));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ReachableLocationsResponse</returns>
        public async System.Threading.Tasks.Task<ReachableLocationsResponse> GetReachableLocationsAsync(Guid? id, int? maximumPollingPeriod = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<ReachableLocationsResponse> localVarResponse = await GetReachableLocationsWithHttpInfoAsync(id, maximumPollingPeriod, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ReachableLocationsResponse)</returns>
        public async System.Threading.Tasks.Task<PTV.Developer.Clients.routing.Client.ApiResponse<ReachableLocationsResponse>> GetReachableLocationsWithHttpInfoAsync(Guid? id, int? maximumPollingPeriod = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
