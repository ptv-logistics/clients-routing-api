...
namespace PTV.Developer.Clients.routing.Api
{
    ...
    public partial class ReachableAreasApi : IReachableAreasApi
    {
        ...
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<ReachableAreasResponse> localVarResponse = GetReachableAreasWithHttpInfo(id, maximumPollingPeriod);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ReachableAreasResponse</returns>
        public PTV.Developer.Clients.routing.Client.ApiResponse<ReachableAreasResponse> GetReachableAreasWithHttpInfo(Guid? id, int? maximumPollingPeriod = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            PTV.Developer.Clients.routing.Client.ApiResponse<ReachableAreasResponse> localVarResponse = await GetReachableAreasWithHttpInfoAsync(id, maximumPollingPeriod, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ReachableAreasResponse)</returns>
        public async System.Threading.Tasks.Task<PTV.Developer.Clients.routing.Client.ApiResponse<ReachableAreasResponse>> GetReachableAreasWithHttpInfoAsync(Guid? id, int? maximumPollingPeriod = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
