...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class Options : IValidatableObject
    {
        ...
        /// <param name="maximumDistanceBetweenEvents">Specifies a maximum distance between consecutive events along the route [m]. When set, additional events are inserted to ensure that no gap between two events exceeds the given distance. These inserted events do not carry a specific type such as _MANEUVER_EVENTS_ or _BORDER_EVENTS_. They appear in the event list with the common event properties only (latitude, longitude, distanceFromStart, travelTimeFromStart, etc.).  The inserted events are not equidistant and are not placed at the midpoint of a gap. Their positions depend on the set of explicitly requested events. Adding or removing requested event types may change the positions of the inserted events. Start and destination will always be present in the event list.  If no other event types are requested, the response will solely contain these basic events.  For a long route and a low value a significant number of events will be inserted..</param>
        public Options(DateTimeOffset? startTime = default(DateTimeOffset?), DateTimeOffset? arrivalTime = default(DateTimeOffset?), DateTimeOffset? tollTime = default(DateTimeOffset?), TrafficMode? trafficMode = default(TrafficMode?), string allowedCountries = default(string), string prohibitedCountries = default(string), bool? preferTurnsOnPassengerSide = false, string avoid = default(string), string blockIntersectingRoads = default(string), string customRoadAttributeScenarios = default(string), RoutingMode? routingMode = default(RoutingMode?), int? maximumSpeed = default(int?), double? speedFactor = 1D, string language = @"en", PolylineFormat? polylineFormat = default(PolylineFormat?), PolylineMapType? polylineMapType = default(PolylineMapType?), string currency = default(string), int? maximumDistanceBetweenEvents = default(int?))
        {
            ...
            this.MaximumDistanceBetweenEvents = maximumDistanceBetweenEvents;
        }
        ...
        /// </summary>
        /// <value>Comma-separated list of countries the route is allowed to pass. By default, all countries are allowed. If this parameter is present, only these countries are allowed to be passed, i.e. drive only in these countries. Countries are represented according to their [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) or [ISO 3166-2](https://en.wikipedia.org/wiki/ISO_3166-2) if referring to a subdivision. This parameter is mutually exclusive with **prohibitedCountries** and will be ignored, if a **routeId** is specified.</value>
        ...
        /// </summary>
        /// <value>Comma-separated list of countries the route must not pass. By default, all countries are allowed. If this parameter is present, all but the given countries are allowed to be passed, i.e. do not drive in these countries.  Countries are represented according to their [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) or [ISO 3166-2](https://en.wikipedia.org/wiki/ISO_3166-2) if referring to a subdivision. This parameter is mutually exclusive with **allowedCountries** and will be ignored, if a **routeId** is specified.</value>
        ...
        /// </summary>
        /// <value>Specifies that the route is constructed such that turns to the passenger side are preferred.  This parameter will be ignored, if **options[routingMode]&#x3D;MONETARY**, **vehicle[truckRoutes]** or a **routeId** is specified. It will also be ignored for non-motorized profiles such as _BICYCLE_ or _PEDESTRIAN_. </value>
        ...
        /// </summary>
        /// <value>Comma-separated list of features which should be avoided on the route. Avoided features could be included in a route if there is no possibility to reach the target otherwise.  Available values are provided by type &#x60;AvoidFeature&#x60;: * &#x60;TOLL&#x60; - Avoid roads with toll. * &#x60;FERRIES&#x60; - Avoid ferries. Ferries which cannot be avoided can be requested with _COMBINED_TRANSPORT_EVENTS_ and will appear with the type _BOAT_. * &#x60;RAIL_SHUTTLES&#x60; - Avoid rail shuttles. Rail shuttles which cannot be avoided can be requested with _COMBINED_TRANSPORT_EVENTS_ and will appear with the type _RAIL_. * &#x60;HIGHWAYS&#x60; - Avoid highways and motorways. Waypoints will not be matched to highways, they will be matched to the nearest road which is not a highway.  This parameter will be ignored, if **options[routingMode]&#x3D;MONETARY** or a **routeId** is specified.  All values except for _FERRIES_ will also be ignored for non-motorized profiles such as _BICYCLE_ or _PEDESTRIAN_. See [here](./concepts/avoid) for more information. </value>
        ...
        /// </summary>
        /// <value>Pipe-separated list of polylines.   Roads and combined transports that intersect the given polylines will be considered as prohibited and will not be used in the route calculation. Each list element is a polyline. Each point is a coordinate of latitude and longitude. Coordinates and points are separated by a comma. Format: &#x60;&lt;poly1_lat1&gt;,&lt;poly1_lon1&gt;,...,&lt;poly1_latN&gt;,&lt;poly1_lonN&gt;|&lt;poly2_lat1&gt;,&lt;poly2_lon1&gt;,...,&lt;poly2_latN&gt;,&lt;poly2_lonN&gt;|...&#x60;   Notes: * Be aware of the URL length restrictions. * If there is no other route connecting two waypoints the will be reported as violated and correspondingly violation events with type **BLOCKED_ROAD_BY_INTERSECTION** will be reported if violation events are requested. * Requests will be rejected if at least one provided polyline   * does not consist of an even number of coordinates,   * consists of less than two points,   * contains invalid coordinates or   * intersects more than 5000 road segments.  This parameter will be ignored, if a **routeId** is specified. </value>
        ...
        /// <summary>
        /// Specifies a maximum distance between consecutive events along the route [m]. When set, additional events are inserted to ensure that no gap between two events exceeds the given distance. These inserted events do not carry a specific type such as _MANEUVER_EVENTS_ or _BORDER_EVENTS_. They appear in the event list with the common event properties only (latitude, longitude, distanceFromStart, travelTimeFromStart, etc.).  The inserted events are not equidistant and are not placed at the midpoint of a gap. Their positions depend on the set of explicitly requested events. Adding or removing requested event types may change the positions of the inserted events. Start and destination will always be present in the event list.  If no other event types are requested, the response will solely contain these basic events.  For a long route and a low value a significant number of events will be inserted.
        /// </summary>
        /// <value>Specifies a maximum distance between consecutive events along the route [m]. When set, additional events are inserted to ensure that no gap between two events exceeds the given distance. These inserted events do not carry a specific type such as _MANEUVER_EVENTS_ or _BORDER_EVENTS_. They appear in the event list with the common event properties only (latitude, longitude, distanceFromStart, travelTimeFromStart, etc.).  The inserted events are not equidistant and are not placed at the midpoint of a gap. Their positions depend on the set of explicitly requested events. Adding or removing requested event types may change the positions of the inserted events. Start and destination will always be present in the event list.  If no other event types are requested, the response will solely contain these basic events.  For a long route and a low value a significant number of events will be inserted.</value>
        [DataMember(Name = "maximumDistanceBetweenEvents", EmitDefaultValue = true)]
        public int? MaximumDistanceBetweenEvents { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MaximumDistanceBetweenEvents: ").Append(MaximumDistanceBetweenEvents).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // MaximumDistanceBetweenEvents (int?) minimum
            if (this.MaximumDistanceBetweenEvents < (int?)500)
            {
                yield return new ValidationResult("Invalid value for MaximumDistanceBetweenEvents, must be a value greater than or equal to 500.", new [] { "MaximumDistanceBetweenEvents" });
            }
