...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class OffRoadWaypoint : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>If true, the service time can be used for a break or rest. This parameter will be ignored, if **serviceTime** is 0 or if no **driver** is specified.</value>
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // ServiceTime (int?) maximum
            if (this.ServiceTime > (int?)31535999)
            {
                yield return new ValidationResult("Invalid value for ServiceTime, must be a value less than or equal to 31535999.", new [] { "ServiceTime" });
            }
