...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class PositionAtWaypoint : IValidatableObject
    {
        ...
        {
            // PerformedServiceTime (int?) maximum
            if (this.PerformedServiceTime > (int?)31535999)
            {
                yield return new ValidationResult("Invalid value for PerformedServiceTime, must be a value less than or equal to 31535999.", new [] { "PerformedServiceTime" });
            }
