...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class RouteRequest : IValidatableObject
    {
        ...
        /// <param name="routeId">Instead of the list of waypoints, a **routeId** from a previously calculated route or a matched track can be entered. See [here](./concepts/route-ids) for more information..</param>
        /// <param name="driver">driver.</param>
        /// <param name="routeOptions">routeOptions.</param>
        public RouteRequest(List<Waypoint> waypoints = default(List<Waypoint>), Guid? routeId = default(Guid?), DriverBody driver = default(DriverBody), RouteOptions routeOptions = default(RouteOptions))
        {
        ...
        /// </summary>
        /// <value>Instead of the list of waypoints, a **routeId** from a previously calculated route or a matched track can be entered. See [here](./concepts/route-ids) for more information.</value>
