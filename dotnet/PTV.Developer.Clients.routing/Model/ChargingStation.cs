...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class ChargingStation : IValidatableObject
    {
        ...
        /// <param name="useServiceTimeForCharging">If true, the service time can be used for charging. This parameter will be ignored, if **serviceTime** is 0. This can have  an influence on charging optimization because the additional time needed for charging is minimized. (default to false).</param>
        ...
        /// </summary>
        /// <value>If true, the service time can be used for charging. This parameter will be ignored, if **serviceTime** is 0. This can have  an influence on charging optimization because the additional time needed for charging is minimized.</value>
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // SetupTime (int?) maximum
            if (this.SetupTime > (int?)31535999)
            {
                yield return new ValidationResult("Invalid value for SetupTime, must be a value less than or equal to 31535999.", new [] { "SetupTime" });
            }
