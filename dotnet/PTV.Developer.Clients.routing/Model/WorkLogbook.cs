...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class WorkLogbook : IValidatableObject
    {
        ...
        {
            // AccumulatedDrivingTimeSinceLastBreak (int?) maximum
            if (this.AccumulatedDrivingTimeSinceLastBreak > (int?)31535999)
            {
                yield return new ValidationResult("Invalid value for AccumulatedDrivingTimeSinceLastBreak, must be a value less than or equal to 31535999.", new [] { "AccumulatedDrivingTimeSinceLastBreak" });
            }
            ...
            // AccumulatedWorkingTimeSinceLastBreak (int?) maximum
            if (this.AccumulatedWorkingTimeSinceLastBreak > (int?)31535999)
            {
                yield return new ValidationResult("Invalid value for AccumulatedWorkingTimeSinceLastBreak, must be a value less than or equal to 31535999.", new [] { "AccumulatedWorkingTimeSinceLastBreak" });
            }
            ...
            // AccumulatedDrivingTimeSinceLastDailyRest (int?) maximum
            if (this.AccumulatedDrivingTimeSinceLastDailyRest > (int?)31535999)
            {
                yield return new ValidationResult("Invalid value for AccumulatedDrivingTimeSinceLastDailyRest, must be a value less than or equal to 31535999.", new [] { "AccumulatedDrivingTimeSinceLastDailyRest" });
            }
            ...
            // AccumulatedTravelTimeSinceLastDailyRest (int?) maximum
            if (this.AccumulatedTravelTimeSinceLastDailyRest > (int?)31535999)
            {
                yield return new ValidationResult("Invalid value for AccumulatedTravelTimeSinceLastDailyRest, must be a value less than or equal to 31535999.", new [] { "AccumulatedTravelTimeSinceLastDailyRest" });
            }
