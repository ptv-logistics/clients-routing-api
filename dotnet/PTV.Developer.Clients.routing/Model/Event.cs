...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class Event : IValidatableObject
    {
        ...
        /// <param name="startsAt">The time at which the event starts formatted according to [RFC 3339](https://tools.ietf.org/html/rfc3339). Will not be present for **trafficMode** _AVERAGE_ or _CONSTANT_ when neither **startTime** nor **arrivalTime** is specified..</param>
        ...
        /// <param name="utcOffset">The offset to UTC [min]. Will not contain daylight-saving time for **trafficMode** _AVERAGE_ or _CONSTANT_ when neither **startTime** nor **arrivalTime** is specified. (required).</param>
        ...
        /// </summary>
        /// <value>The time at which the event starts formatted according to [RFC 3339](https://tools.ietf.org/html/rfc3339). Will not be present for **trafficMode** _AVERAGE_ or _CONSTANT_ when neither **startTime** nor **arrivalTime** is specified.</value>
        ...
        /// </summary>
        /// <value>The offset to UTC [min]. Will not contain daylight-saving time for **trafficMode** _AVERAGE_ or _CONSTANT_ when neither **startTime** nor **arrivalTime** is specified.</value>
