...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class Leg : IValidatableObject
    {
        ...
        /// <param name="elevationReport">elevationReport.</param>
        public Leg(int? distance = default(int?), int? travelTime = default(int?), int? trafficDelay = default(int?), bool? violated = default(bool?), TollCosts tollCosts = default(TollCosts), string polyline = default(string), EvReportLeg evReport = default(EvReportLeg), ElevationReport elevationReport = default(ElevationReport))
        {
        ...
        /// <summary>
        /// Gets or Sets ElevationReport
        /// </summary>
        [DataMember(Name = "elevationReport", EmitDefaultValue = false)]
        public ElevationReport ElevationReport { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ElevationReport: ").Append(ElevationReport).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
