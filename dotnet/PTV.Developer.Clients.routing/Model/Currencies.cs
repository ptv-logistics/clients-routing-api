...
namespace PTV.Developer.Clients.routing.Model
{
    ...
    public partial class Currencies : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Currencies" /> class.
        /// </summary>
        /// <param name="date">The date of the exchange rates formatted according to [RFC 3339](https://tools.ietf.org/html/rfc3339). The rate may be older if there is no newer rate available. (required).</param>
        ...
        /// </summary>
        /// <value>The date of the exchange rates formatted according to [RFC 3339](https://tools.ietf.org/html/rfc3339). The rate may be older if there is no newer rate available.</value>
